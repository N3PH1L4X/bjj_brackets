...
CREATE TABLE IF NOT EXISTS `bjj_brackets`.`competidor` (
  ...
  `cinturon_competidor` VARCHAR(45) NOT NULL,
...
START TRANSACTION;
USE `bjj_brackets`;
INSERT INTO `bjj_brackets`.`competidor` (`id_competidor`, `rut_competidor`, `nombre_competidor`, `primer_apellido_competidor`, `segundo_apellido_competidor`, `peso_competidor`, `cinturon_competidor`, `edad_competidor`, `correo_competidor`, `telefono_competidor`, `escuela_id_escuela`) VALUES (1, '26762822', 'Jose Andres', 'Lopez', 'Serrano', 93, 'Blanco', 23, 'joseals0404@gmail.com', '+56963202779', 1);
INSERT INTO `bjj_brackets`.`competidor` (`id_competidor`, `rut_competidor`, `nombre_competidor`, `primer_apellido_competidor`, `segundo_apellido_competidor`, `peso_competidor`, `cinturon_competidor`, `edad_competidor`, `correo_competidor`, `telefono_competidor`, `escuela_id_escuela`) VALUES (2, '11223344', 'Nombre1', 'Apellido1', 'SApellido1', 80, 'Azul', 23, 'correo@correo.com', '+56999999474', 2);
INSERT INTO `bjj_brackets`.`competidor` (`id_competidor`, `rut_competidor`, `nombre_competidor`, `primer_apellido_competidor`, `segundo_apellido_competidor`, `peso_competidor`, `cinturon_competidor`, `edad_competidor`, `correo_competidor`, `telefono_competidor`, `escuela_id_escuela`) VALUES (3, '22334455', 'Nombre2', 'Apellido2', 'SApellido2', 71, 'Marron', 20, 'correo2@correo.com', '+56994477414', 1);
